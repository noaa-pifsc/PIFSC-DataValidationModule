/************************************************************************************
 Filename   : upgrade_dev_retain_data_0.1_to_1.4.sql
 Author     :
 Purpose    : Automated upgrade script for the Data Validation Module database while retaining the data in the existing objects, this is intended for use on the development environment to upgrade DVM version 0.1 to 1.4
...
@@"upgrades/DVM_DDL_DML_upgrade_v0.5_pt1.sql"
@@"scripts/migrate_error_type_assoc_values.sql"
@@"upgrades/DVM_DDL_DML_upgrade_v0.5_pt2.sql"
...
--upgrade the DVM_ERRORS_EXCLUDE table to use the DVM_ISSUES table
@@"../docs/SPTT Upgrade/scripts/DVM_ERRORS_EXCLUDE_upgrade.sql"

...
CREATE SEQUENCE DVM_DATA_STREAMS_HIST_SEQ INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE DVM_ERRORS_EXCLUDE_SEQ INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE DVM_ERRORS_HIST_SEQ INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE DVM_ERROR_TYPES_SEQ INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE DVM_ERROR_TYPES_HIST_SEQ INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE DVM_ERR_RES_TYPES_SEQ INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE DVM_ERR_RES_TYPES_HIST_SEQ INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE DVM_ERR_SEVERITY_SEQ INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE DVM_ERR_SEVERITY_HIST_SEQ INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE DVM_PTA_ERRORS_SEQ INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE DVM_PTA_ERRORS_HIST_SEQ INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE DVM_PTA_ERR_TYP_ASSOC_SEQ INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE DVM_QC_OBJECTS_SEQ INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE DVM_QC_OBJECTS_HIST_SEQ INCREMENT BY 1 START WITH 1;
...
CREATE TABLE DVM_ERRORS_EXCLUDE
(
  ERROR_ID  NUMBER                              NOT NULL,
...
COMMENT ON TABLE DVM_ERRORS_EXCLUDE IS 'Store error ids excluded from validation reports';
...
CREATE TABLE DVM_PTA_ERRORS_HIST
(
  H_SEQNUM              NUMBER(10)              NOT NULL,
  PTA_ERROR_ID          NUMBER                  NOT NULL,
  H_TYPE_OF_CHANGE      VARCHAR2(10 BYTE)       NOT NULL,
...
COMMENT ON COLUMN DVM_PTA_ERRORS_HIST.H_SEQNUM IS 'A unique number for this record in the history table';

COMMENT ON COLUMN DVM_PTA_ERRORS_HIST.PTA_ERROR_ID IS 'Primary key column of the data table';

COMMENT ON COLUMN DVM_PTA_ERRORS_HIST.H_TYPE_OF_CHANGE IS 'The type of change is INSERT, UPDATE or DELETE';

COMMENT ON COLUMN DVM_PTA_ERRORS_HIST.H_DATE_OF_CHANGE IS 'The date and time the change was made to the data';

COMMENT ON COLUMN DVM_PTA_ERRORS_HIST.H_USER_MAKING_CHANGE IS 'The person (Oracle username) making the change to the record';

COMMENT ON COLUMN DVM_PTA_ERRORS_HIST.H_OS_USER IS 'The OS username of the person making the change to the record';

COMMENT ON COLUMN DVM_PTA_ERRORS_HIST.H_CHANGED_COLUMN IS 'If the type of change is INSERT or UPDATE, the name of the column being changed';

COMMENT ON COLUMN DVM_PTA_ERRORS_HIST.H_OLD_DATA IS 'The data that has been updated';

COMMENT ON COLUMN DVM_PTA_ERRORS_HIST.H_NEW_DATA IS 'The updated column data';
...
COMMENT ON COLUMN DVM_PTA_ERR_TYP_ASSOC.ERR_ASSOC_NOTES IS 'Notes';
...
CREATE UNIQUE INDEX DVM_DATA_STREAMS_PK ON DVM_DATA_STREAMS
(DATA_STREAM_ID);

CREATE UNIQUE INDEX DVM_DATA_STREAMS_U1 ON DVM_DATA_STREAMS
(DATA_STREAM_CODE);

CREATE UNIQUE INDEX DVM_DATA_STREAMS_U2 ON DVM_DATA_STREAMS
(DATA_STREAM_NAME);

CREATE UNIQUE INDEX DVM_ERRORS_EXCLUDE_PK ON DVM_ERRORS_EXCLUDE
(ERROR_ID);

CREATE INDEX DVM_ERRORS_I1 ON DVM_ERRORS
(PTA_ERROR_ID);

CREATE INDEX DVM_ERRORS_I2 ON DVM_ERRORS
(ERROR_TYPE_ID);

CREATE INDEX DVM_ERRORS_I3 ON DVM_ERRORS
(ERR_RES_TYPE_ID);

CREATE UNIQUE INDEX DVM_ERRORS_PK ON DVM_ERRORS
(ERROR_ID);

CREATE INDEX DVM_ERROR_TYPES_I1 ON DVM_ERROR_TYPES
(QC_OBJECT_ID);

CREATE INDEX DVM_ERROR_TYPES_I2 ON DVM_ERROR_TYPES
(ERR_SEVERITY_ID);

CREATE INDEX DVM_ERROR_TYPES_I3 ON DVM_ERROR_TYPES
(DATA_STREAM_ID);

CREATE UNIQUE INDEX DVM_ERROR_TYPES_PK ON DVM_ERROR_TYPES
(ERROR_TYPE_ID);

CREATE UNIQUE INDEX DVM_ERROR_TYPES_U1 ON DVM_ERROR_TYPES
(IND_FIELD_NAME, DATA_STREAM_ID, QC_OBJECT_ID);

CREATE UNIQUE INDEX DVM_ERR_RES_TYPES_PK ON DVM_ERR_RES_TYPES
(ERR_RES_TYPE_ID);

CREATE UNIQUE INDEX DVM_ERR_RES_TYPES_U1 ON DVM_ERR_RES_TYPES
(ERR_RES_TYPE_CODE);

CREATE UNIQUE INDEX DVM_ERR_RES_TYPES_U2 ON DVM_ERR_RES_TYPES
(ERR_RES_TYPE_NAME);

CREATE UNIQUE INDEX DVM_ERR_SEVERITY_PK ON DVM_ERR_SEVERITY
(ERR_SEVERITY_ID);

CREATE UNIQUE INDEX DVM_ERR_SEVERITY_U1 ON DVM_ERR_SEVERITY
(ERR_SEVERITY_CODE);

CREATE UNIQUE INDEX DVM_ERR_SEVERITY_U2 ON DVM_ERR_SEVERITY
(ERR_SEVERITY_NAME);

CREATE UNIQUE INDEX DVM_PTA_ERRORS_PK ON DVM_PTA_ERRORS
(PTA_ERROR_ID);

CREATE INDEX DVM_PTA_ERR_TYP_ASSOC_I1 ON DVM_PTA_ERR_TYP_ASSOC
(PTA_ERROR_ID);

CREATE INDEX DVM_PTA_ERR_TYP_ASSOC_I2 ON DVM_PTA_ERR_TYP_ASSOC
(ERROR_TYPE_ID);

CREATE UNIQUE INDEX DVM_PTA_ERR_TYP_ASSOC_PK ON DVM_PTA_ERR_TYP_ASSOC
(PTA_ERR_TYP_ASSOC_ID);

CREATE UNIQUE INDEX DVM_PTA_ERR_TYP_ASSOC_U1 ON DVM_PTA_ERR_TYP_ASSOC
(PTA_ERROR_ID, ERROR_TYPE_ID);

CREATE UNIQUE INDEX DVM_QC_OBJECTS_PK ON DVM_QC_OBJECTS
(QC_OBJECT_ID);
...
CREATE OR REPLACE TRIGGER "TRG_DVM_PTA_ERRORS_HIST"
AFTER DELETE OR INSERT OR UPDATE
ON DVM_PTA_ERRORS
REFERENCING OLD AS old NEW AS new
FOR EACH ROW

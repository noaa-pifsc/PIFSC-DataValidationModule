...
INSERT INTO DB_UPGRADE_LOGS (UPGRADE_APP_NAME, UPGRADE_VERSION, UPGRADE_DATE, UPGRADE_DESC) VALUES ('Data Validation Module', '0.7', TO_DATE('09-JUL-20', 'DD-MON-YY'), 'Removed DVM synonyms.  Updated the DVM_PKG package to include code comments, error logging, procedure/function logging, return code values for all procedures to indicate their success/error conditions.  Updated DVM_QC_MSG_MISS_FIELDS_V to use the updated DVM_PKG.QC_MISSING_QUERY_FIELDS_FN function name and arguments.  Requires version 0.2 (Git tag: db_log_db_v0.2) of the Database Logging Module Database (Git URL: git@github.com:PIFSC-NMFS-NOAA/PIFSC-DBLoggingModule.git).');

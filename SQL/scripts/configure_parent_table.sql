--define the bind parameters to specify the table name, unique key name, and foreign key name to genrate the DDL necessary to update a given parent table and enable it in the data validation module (allows validation issue records to be associated with the parent table)

...
--define the upgrade version in the database upgrade log table (bug fix replaced the existing DVM_PKG package DDL instead of appending updated code at the end):

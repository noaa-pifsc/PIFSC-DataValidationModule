/************************************************************************************
 Filename   : deploy_dev_rollback_v1.4.sql
 Author     :
...
SELECT 'DVM_rollback_dev_v1.4_' || TO_CHAR( SYSDATE, 'yyyymmdd' ) spool_fname FROM DUAL;
...
@rollback/DVM_DDL_DML_rollback_v1.4.sql

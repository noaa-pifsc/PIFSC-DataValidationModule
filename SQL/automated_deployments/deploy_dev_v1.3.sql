/************************************************************************************
 Filename   : deploy_dev_v1.3.sql
 Author     :
 Purpose    : Automated deployment script for the Data Validation Module database, this is intended for use on the development environment
...
SELECT 'DVM_deploy_dev_v1.3_' || TO_CHAR( SYSDATE, 'yyyymmdd' ) spool_fname FROM DUAL;
